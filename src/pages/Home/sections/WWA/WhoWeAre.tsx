const WhoWeAre = () => {
  return (
    <>
      <section className="h-screen flex justify-between max-sm:flex-col max-sm:items-start  mt-25 max-md:mt-0 px-10 gap-10 max-sm:gap-7 max-sm:px-5 max-sm:h-auto">

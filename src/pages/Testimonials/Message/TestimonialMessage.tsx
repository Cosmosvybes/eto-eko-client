  ...
  return (
    <>
      <motion.div
        ...
        className="max-sm:border max-md:border rounded-lg border-gray-200 w-full h-auto flex justify-between items-center p-10 gap-10 max-sm:p-4 relative"
      >
        <motion.div
          initial={{ opacity: 0, scale: 0 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ type: "tween", ease: "backIn", duration: 1 }}
          className="relative -z-10  rounded-full rounded-bl-none  w-52 h-44 bg-[#074941] max-sm:absolute max-md:absolute top-2 right-0  max-sm:w-12 max-sm:h-12 max-md:h-20 max-md:w-20 max-sm:right-2 max-md:right-3 max-sm:top-3 "
        >

          ...
          <div className="w-10/12 h-full block  max-md:px-20  px-28 max-sm:px-4 max-sm:w-full max-md:w-full">
            ...
            <div className=" flex flex-col gap-5 mt-4">
              <p className="font-normal">
                Global education is about bridging worlds, and we specialize in
                connecting students and institutions across borders with
            ...
            <div className=" flex flex-col gap-5 mt-4">
              <p className="font-normal">
                ...
                prioritizing ethics over profit, we ensure that every placement
                reflects the student’s best interest, not institutional quotas
                or short-term gains.
              </p>

              <p className="font-normal">
                Transparency runs through every stage of our process. We provide
                students with clear, detailed information about programs, fees,
                living costs, and future opportunities before they make
                decisions. There are no hidden agendas or misleading promises.
                We empower students and families to make informed choices,
                equipping them with facts rather than pressure. This trust-based
                approach builds confidence and reassures students that they are
                valued as individuals, not statistics.
              </p>
            </div>
            ...
            <div className=" flex flex-col gap-5 mt-4">
              <p className="font-normal">
                ...
                historically excluded certain groups, whether due to financial,
                cultural, or social barriers. Our mission is to dismantle those
                barriers by creating systems and pathways that actively promote
                equity. From offering scholarships and funding guidance to
                advocating for accessibility, we ensure that opportunities reach
                those who might otherwise be left behind. We believe global
                education should be a right, not a privilege.
              </p>

              <p className="font-normal">
                Our inclusive approach extends to institutional partnerships as
                well. We work with universities and organizations to embed
                inclusivity into their policies, recruitment strategies, and
                classroom environments. This includes advising on gender equity,
                cultural diversity, and accessibility measures that make
                campuses welcoming to all students. By promoting diversity in
                every program we touch, we help institutions build vibrant,
                multicultural communities where every student feels valued and
                represented.
              </p>
            </div>
            ...
            <div className=" flex flex-col gap-5 mt-4">
              <p className="font-normal">
                Our greatest strength lies in the people who drive our mission.
                Our consultants and advisors come from diverse backgrounds,
                including higher education, international affairs, student
                counseling, and cultural policy. This diversity of expertise
                allows us to provide holistic guidance that goes beyond
                admissions. Each member of our team brings unique perspectives,
                lived experiences, and specialized skills that collectively
                enhance the quality of service we offer. Together, we form a
                mission-led unit that prioritizes impact over profit
              </p>

              <p className="font-normal">
                Experience allows us to anticipate challenges and provide
                solutions that are practical and effective. Having worked within
                universities and across international education sectors, our
                advisors understand both sides of the journey—the institutional
                priorities and the student realities. This dual insight allows
                us to bridge gaps, create smoother transitions, and design
                strategies that meet the needs of both students and
                institutions. Students benefit not only from technical knowledge
                but also from empathetic guidance shaped by real-world
                understanding
              </p>
            </div>
          </div>
